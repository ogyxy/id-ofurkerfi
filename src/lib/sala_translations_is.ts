...
export const t = {
  ...
  login: {
    ...
    notActivated:    'Aðgangurinn þinn hefur ekki verið virkjaður. Hafðu samband við stjórnanda.',
    staffTitle:      'Starfsfólk',
    staffSubtitle:   'Skráðu þig inn með Microsoft-aðgangi IDÉ',
    microsoftButton: 'Skrá inn með Microsoft',
    or:              'eða',
    guestTitle:      'Gestur',
    guestSubtitle:   'Skráðu þig inn með netfangi og lykilorði',
  },
  ...
  settings: {
    ...
    tabProfile:          'Mínar stillingar',
    tabUsers:            'Starfsfólk',
    tabApp:              'Forrit',

    profileSection:      'Persónuupplýsingar',
    displayName:         'Nafn',
    avatar:              'Prófílmynd',
    avatarUpload:        'Velja mynd',
    avatarRemove:        'Fjarlægja',
    passwordSection:     'Lykilorð',
    currentPassword:     'Núverandi lykilorð',
    newPassword:         'Nýtt lykilorð',
    confirmPassword:     'Staðfesta nýtt lykilorð',
    changePassword:      'Breyta lykilorði',
    passwordMismatch:    'Lykilorð stemma ekki',
    passwordTooShort:    'Lykilorð verður að vera minnst 8 stafir',
    passwordChanged:     'Lykilorði breytt',
    passwordSsoNotice:   'Lykilorði er stjórnað af Microsoft fyrir starfsfólk.',

    usersTitle:          'Starfsfólk',
    inviteUser:          'Bjóða notanda',
    inviteEmail:         'Netfang',
    inviteRole:          'Hlutverk',
    inviteSend:          'Senda boð',
    inviteSending:       'Sendir...',
    inviteSent:          'Boð sent',
    inviteFailed:        'Ekki tókst að senda boð',
    userName:            'Nafn',
    userEmail:           'Netfang',
    userRole:            'Hlutverk',
    userStatus:          'Staða',
    userActive:          'Virkur',
    userInactive:        'Óvirkur',
    editUser:            'Breyta',
    deactivateUser:      'Gera óvirkan',
    activateUser:        'Virkja',
    saveUser:            'Vista',
    cannotEditSelf:      'Þú getur ekki breytt þínu eigin hlutverki',

    appTitle:            'Forrit',
    appCompanyName:      'Nafn fyrirtækis',
    appCompanyLogo:      'Lógó',
    appDefaultCurrency:  'Sjálfgefinn gjaldmiðill',
    appPaydayStatus:     'Staða Payday-tengingar',
  ...
  deal: {
    ...
    filterAfhentLinked:       'Tengt Payday',
    filterAfhentUnlinked:     'Ekki tengt Payday',
  ...
  purchaseOrder: {
    ...
    actionMarkDeliveredToCustomer: 'Sala afhent',
    actionMarkAllDeliveredToCustomer: 'Sala afhent (allar)',
    ...
    confirmOrderWithPo:      'Staðfesta og bæta við PO',
    pillDeliveredToCustomer: 'Afhent viðskiptavini',
    deliveredToCustomerOn:   'Afhent viðskiptavini',
    estimatedDeliveryShort:  'Áætluð móttaka',
    invoiceRegisteredShort:  'Reikningur skráður',
    paidShort:               'Greitt',
    rowMenuEditExchange:     'Breyta gengi',
    rowMenuEditLines:        'Breyta línum',
    rowMenuEditInvoice:      'Breyta reikningi',
    ...
    deletePoConfirmYes:      'Já, eyða',
    phase2Tooltip:           'Kemur í næsta áfanga',
    invoiceMismatchTooltip:  'Reikningur stemmir ekki',
    editLinesTitle:          'Breyta línum',
    editExchangeTitle:       'Breyta gengi',
    addLine:                 '+ Bæta við línu',
    lineDescription:         'Lýsing',
    lineQuantity:            'Magn',
    lineUnitCost:            'Einingaverð',
    lineSku:                 'SKU',
    deleteLine:              'Eyða línu',
    invoiceFileRequired:     'Reikningsskjal er nauðsynlegt',
  ...
  yfirlit: {
    ...
    paceDaysLeft:     '{n} dagar eftir',
    paceAhead:        'Á undan áætlun',
    ...
    spotlightMovement:'🚀 Mest hreyfing í vikunni — {name} +{pct}%',
    spotlightBiggest: '🏆 Stærsta sala vikunnar — {name} · {company} {amount}',
    spotlightMargin:  '💎 Besta framlegð síðustu 30 daga — {name} {pct}%',
    spotlightStreak:  '🔥 Lengsta röð — {name}, {days} dagar í röð',
    spotlightFallback:'Engin sérstök hreyfing í vikunni — góð vika framundan!',

    tasksFilterFor:   'Verkefni fyrir:',
    tasksTierCritical:'Bráðnauðsynlegt',
    tasksTierUrgent:  'Áríðandi',
    tasksTierAdvisory:'Til athugunar',
    tasksAllClear:    'Engin verkefni krefjast athygli í dag ☕',
    tasksStaleOverdue:'{n} dögum yfir á gjalddaga',
    tasksStaleUninvoiced:'{n} dögum frá afhendingu án reiknings',
    ...
    warningsMarginDrop:'Framlegð að lækka',
    warningsMarginDropDetail:'Framlegð: {prev}% → {curr}% (síðustu 3 mánuðir)',
    warningsMarginAllClear:'Engin framlegðaviðvörun. ✓',
    warningsDormant:  'Viðskiptavinir í dvala',
    ...
    adminMarginLow:   'Lægsta framlegð',
    adminConcentration:'Viðskiptaáhætta',
    adminConcentrationLine:'Topp 5 viðskiptavinir: {pct}% af veltu',
    adminConcentrationWarning:'Veltan er háð fáum viðskiptavinum.',
    adminStageDays:   '{n} dagar í {stage}',

    viewDashboardAs:  'Skoða mælaborð sem',
    viewDashboardAll: 'Allt liðið',
  },
