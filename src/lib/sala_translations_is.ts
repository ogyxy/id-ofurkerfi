...
export const t = {
  ...
  deal: {
    ...
    trackingsoPartialDeliveryTitle: 'Ekki allar pantanir komnar í hús',
    trackingsoPartialDeliveryBody:  '{outstanding} af {total} pöntunum eru ekki komnar í hús. Merkja samt?',
    trackingsoPartialDeliveryMarkAll:'Merkja allar pantanir komnar í hús',
    trackingsoPartialDeliverySoOnly:'Já, merkja samt',
